...
export default function InvoicePreviewModal({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-tsw-ink/70 backdrop-blur-sm animate-fade-in no-print">
      <div className="bg-tsw-bg rounded-xl sm:rounded-2xl w-full max-w-5xl border border-tsw-border shadow-tsw-modal overflow-hidden flex flex-col h-[94vh]">
        
        {/* Top Action Toolbar (Mobile & Desktop Responsive) */}
        <div className="bg-white border-b border-tsw-border p-3 sm:p-4 flex flex-wrap items-center justify-between gap-2 shrink-0">
          
          {/* Left: Mode Switcher (Invoice vs Receipt) */}
          ...
          <div className="flex items-center space-x-1.5 sm:space-x-2">
            ...
            <button
              ...
              className="p-2 sm:px-3 sm:py-2 rounded-xl border border-tsw-border text-tsw-ink hover:bg-tsw-subtle transition-colors text-xs font-semibold flex items-center gap-1.5"
        ...
        {/* Scrollable Document Container: Perfectly Centered on All Devices */}
        <div className="flex-1 overflow-y-auto p-3 sm:p-6 bg-tsw-bg flex justify-center items-start">
